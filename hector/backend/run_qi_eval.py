...
TEST_QUERIES = [
    ...
    },
    {
        ...
        "category": "exact",
        "kw": ["bail", "Bharatiya Nagarik", "anticipatory", "bailable", "non-bailable"],
    },
    {
        "id": 4,
    ...
    },
    {
        ...
        "category": "exact",
        "kw": ["54", "sale", "transfer", "ownership", "price"],
    },
    {
        "id": 6,
    ...
    },
    {
        ...
        "category": "exact",
        "kw": ["personal liberty", "Constitution", "protection of life"],
    },
    {
        "id": 10,
        "query": "Consumer Protection Act Section 38 unfair trade practice",
        "category": "exact",
        "kw": ["Section 38", "consumer", "District Commission", "complaint"],
    },
    {
        "id": 11,
    ...
    },
    {
        ...
        "category": "similar",
        "kw": ["dowry", "cruelty", "498A", "maintenance", "husband", "harassment"],
    },
    {
        "id": 13,
    ...
    },
    {
        ...
        "category": "similar",
        "kw": ["limitation", "time limit", "Limitation Act", "suit", "period"],
    },
    {
        "id": 16,
...
def run():
    ...
    for q in TEST_QUERIES:
        ...
        has_section = bool(
            entity_dict.get("sections")
            or entity_dict.get("ipc_sections")
            or entity_dict.get("bns_sections")
        )
        ...
        if has_section or has_act:
            search_results = retriever.search_with_metadata_filters(
                search_query, entity_dict, top_k=10
            )
        else:
        ...
        print("-" * 80)
        print(
            f"Q{q['id']:2d} [{category:9s}] {score:3d}/100 [{status}] {elapsed * 1000:6.0f}ms"
        )
        print(f"    Query: {query}")
        ...
        print(
            f"    Search Method: {'filtered' if (has_section or has_act) else 'unfiltered'}"
        )

...
TEST_QUERIES = [
    ...
    {"id": 3, "query": "Bharatiya Nagarik Suraksha Sanhita bail provisions", "category": "exact", "kw": ["bail", "Bharatiya Nagarik", "anticipatory", "bailable", "non-bailable"]},
    ...
    {"id": 5, "query": "Transfer of Property Act Section 54 sale of immovable property", "category": "exact", "kw": ["54", "sale", "transfer", "ownership", "price"]},
    {"id": 6, "query": "Section 144 CrPC now Section 163 BNSS power to issue orders", "category": "exact", "kw": ["144", "163", "CrPC", "order", "power", "Bharatiya Nagarik Suraksha Sanhita", "Code of Criminal Procedure"]},
    ...
    {"id": 9, "query": "Article 21 Constitution of India right to life and personal liberty", "category": "exact", "kw": ["personal liberty", "Constitution", "protection of life"]},
    {"id": 10, "query": "Consumer Protection Act Section 38 unfair trade practice", "category": "exact", "kw": ["Section 38", "consumer", "District Commission", "complaint"]},
    {"id": 11, "query": "What happens if someone is charged with a crime they didn't commit?", "category": "similar", "kw": ["false", "wrongful", "acquittal", "innocent", "prosecution", "accused", "offence"]},
    {"id": 12, "query": "My in-laws are demanding money from me. What legal options do I have?", "category": "similar", "kw": ["dowry", "cruelty", "498A", "maintenance", "husband", "harassment"]},
    ...
    {"id": 15, "query": "What is the time limit to file a civil suit in India?", "category": "similar", "kw": ["limitation", "time limit", "Limitation Act", "suit", "period"]},
    ...
    {"id": 20, "query": "What rights does an accused person have during police interrogation?", "category": "similar", "kw": ["accused", "rights", "police", "legal counsel", "advocate", "interrogation", "Section 41D"]},

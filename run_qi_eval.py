...
TEST_QUERIES = [
    ...
    {"id": 3, "query": "Bharatiya Nagarik Suraksha Sanhita bail provisions", "category": "exact", "kw": ["bail", "BNSS", "Bharatiya Nagarik", "anticipatory", "bailable"]},
    ...
    {"id": 6, "query": "Section 144 CrPC now Section 163 BNSS power to issue orders", "category": "exact", "kw": ["144", "163", "BNSS", "CrPC", "order", "Bharatiya Nagarik Suraksha Sanhita", "Code of Criminal Procedure"]},
    ...
    {"id": 10, "query": "Consumer Protection Act Section 38 unfair trade practice", "category": "exact", "kw": ["Section 38", "consumer", "District Commission", "complaint", "unfair trade"]},
    ...
    {"id": 20, "query": "What rights does an accused person have during police interrogation?", "category": "similar", "kw": ["accused", "rights", "police", "legal counsel", "BNSS", "advocate", "interrogation", "Section 41D"]},
